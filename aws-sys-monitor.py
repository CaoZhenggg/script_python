...
hosts = {
    'aws-nginx': '52.194.179.83',
    'tir-nginx-b-aws': '18.179.223.245',
    'tir-nginx-a-aws': '52.194.179.83',
    'walianwang-app-aws': '52.198.193.245',
    'walianwang-db-aws': '18.182.28.0',
    'hbase-master-aws': '18.179.49.199',
    'redis-aws': '13.231.250.40',
    'node-server-a-aws': '18.182.21.48',
    'hbase-slave1-aws': '18.179.50.202',
    'node-server-b-aws': '13.230.39.120',
    'rabbitmq-aws': '18.179.62.31',
    'tir-mq-aws': '13.230.35.113',
    'hbase-slave2-aws': '18.182.20.131',
    'crawler-test-aws': '18.182.58.238'
}
